...
MGF_folder<-paste0(projectDir,"/MGFFiles/")
...
# results_comet_TyD$Fraction<-lapply(strsplit(paste(results_comet_TyD$datfile),"_corrected"),"[",1)
...
results_comet_TyD<-unique(results_comet_TyD)
...
# Comet_merged$ScanNumber<-lapply(strsplit(paste(Comet_merged$scanstring),"\\."),"[",2)
...
# results_omssa_TyD$Fraction<-lapply(strsplit(paste(results_omssa_TyD$datfile),"_corrected"),"[",1)
# results_omssa_TyD$MGFfile<-paste0(results_omssa_TyD$Fraction,".mgf")
# results_omssa_TyD$Query<-paste(results_omssa_TyD$Fraction, results_omssa_TyD$ScanNumber, sep="_")
# results_omssa_TyD$PSM<-paste(results_omssa_TyD$Query,results_omssa_TyD$PeptideSeq, sep="_")
results_omssa_TyD<-unique(results_omssa_TyD)
...
# results_tandem_TyD$ScanNumber<-lapply(strsplit(paste(results_tandem_TyD$ScanString),"\\."),"[",2)
...
results_tandem_TyD<-unique(results_tandem_TyD)
results_tandem_TyD$ProteinAccession<-lapply(strsplit(paste(results_tandem_TyD$ProteinAccession)," "),"[",1)
...
results_mascot$PSM<-gsub("%2d","-",results_mascot$PSM)
results_mascot$PSM<-gsub("%23","#", results_mascot$PSM)
...
results_tandem_annot_disc$ProteinAccession<-as.factor(paste(results_tandem_annot_disc$ProteinAccession))
...
cat("ya estoy aqui","\n")
results_omssa_annot_disc_2UniqPep$ProteinAccession<-as.character(paste(results_omssa_annot_disc_2UniqPep$ProteinAccession))
...
results_comet_annot_disc_2UniqPep$ProteinAccession<-as.character(paste(results_comet_annot_disc_2UniqPep$ProteinAccession))
results_mascot_annot_disc_2UniqPep$ProteinAccession<-as.character(paste(results_mascot_annot_disc_2UniqPep$ProteinAccession))
results_tandem_annot_disc_2UniqPep$ProteinAccession<-as.character(paste(results_tandem_annot_disc_2UniqPep$ProteinAccession))
...
results_comet_annot_disc_2UniqPep$PSM<-toupper(results_comet_annot_disc_2UniqPep$PSM)
results_mascot_annot_disc_2UniqPep$PSM<-toupper(results_mascot_annot_disc_2UniqPep$PSM)
results_tandem_annot_disc_2UniqPep$PSM<-toupper(results_tandem_annot_disc_2UniqPep$PSM)
results_omssa_annot_disc_2UniqPep$PSM<-toupper(results_omssa_annot_disc_2UniqPep$PSM)

results_comet_annot_disc_2UniqPep$PSM<-gsub("-","_",results_comet_annot_disc_2UniqPep$PSM)
results_comet_annot_disc_2UniqPep$PSM<-gsub("#","_",results_comet_annot_disc_2UniqPep$PSM)

results_mascot_annot_disc_2UniqPep$PSM<-gsub("-","_",results_mascot_annot_disc_2UniqPep$PSM)
results_mascot_annot_disc_2UniqPep$PSM<-gsub("#","_",results_mascot_annot_disc_2UniqPep$PSM)

results_omssa_annot_disc_2UniqPep$PSM<-gsub("-","_",results_omssa_annot_disc_2UniqPep$PSM)
results_omssa_annot_disc_2UniqPep$PSM<-gsub("#","_",results_omssa_annot_disc_2UniqPep$PSM)
results_omssa_annot_disc_2UniqPep$PeptideSeq<-toupper(results_omssa_annot_disc_2UniqPep$PeptideSeq)

results_tandem_annot_disc_2UniqPep$PSM<-gsub("-","_",results_tandem_annot_disc_2UniqPep$PSM)
results_tandem_annot_disc_2UniqPep$PSM<-gsub("#","_",results_tandem_annot_disc_2UniqPep$PSM)
...
databasename<-"uniprot_2018_10"
pdf(file = paste0(plotDir, "results_Venn_ProteinsPerSearchEngine.pdf"), width = 10, height = 10)
compare4List(paste(unique(results_comet_annot_disc_2UniqPep$ProteinAccession)), paste(unique(results_mascot_annot_disc_2UniqPep$ProteinAccession)), paste(unique(results_omssa_annot_disc_2UniqPep$ProteinAccession)), paste(unique(results_tandem_annot_disc_2UniqPep$ProteinAccession)), "Comet results", "Mascot results", "Omssa results", "Tandem results",  paste0("Proteins (", databasename, ") identified with 2 unique peptides. Results for each search engine."))
dev.off()

pdf(file = paste0(plotDir, "results_Venn_PeptidesPerSearchEngine.pdf"), width = 10, height = 10)
compare4List(paste(unique(results_comet_annot_disc_2UniqPep$PeptideSeq)), paste(unique(results_mascot_annot_disc_2UniqPep$PeptideSeq)), paste(unique(results_omssa_annot_disc_2UniqPep$PeptideSeq)), paste(unique(results_tandem_annot_disc_2UniqPep$PeptideSeq)), "Comet results", "Mascot results", "Omssa results", "Tandem results",  paste0("Peptides of proteins (", databasename, ") identified with 2 unique peptides. Results for each search engine"))
dev.off()

pdf(file = paste0(plotDir, "results_Venn_PSM.pdf"), width = 10, height = 10)
compare4List(paste(unique(results_comet_annot_disc_2UniqPep$PSM)), paste(unique(results_mascot_annot_disc_2UniqPep$PSM)), paste(unique(results_omssa_annot_disc_2UniqPep$PSM)), paste(unique(results_tandem_annot_disc_2UniqPep$PSM)), "Comet results", "Mascot results", "Omssa results", "Tandem results",  paste0("PSM (", databasename, ") identified with 2 unique peptides. Results for each search engine"))
dev.off()

library(UpSetR)

listInput <- list(mascot = paste(results_mascot_annot_disc_2UniqPep$ProteinAccession) , comet = paste(results_comet_annot_disc_2UniqPep$ProteinAccession), omssa =paste(results_omssa_annot_disc_2UniqPep$ProteinAccession), tandem=paste(results_tandem_annot_disc_2UniqPep$ProteinAccession)  )

pdf(file = paste0(plotDir, "results_upsetR_ProteinsPerSearchEngine.pdf"), width = 10, height = 10)
upset(fromList(listInput), order.by = "freq")
dev.off()

listInput <- list(mascot = paste(results_mascot_annot_disc_2UniqPep$PeptideSeq) , comet = paste(results_comet_annot_disc_2UniqPep$PeptideSeq), omssa =paste(results_omssa_annot_disc_2UniqPep$PeptideSeq), tandem=paste(results_tandem_annot_disc_2UniqPep$PeptideSeq)  )

pdf(file = paste0(plotDir, "results_upsetR_PeptidesPerSearchEngine.pdf"), width = 10, height = 10)
upset(fromList(listInput), order.by = "freq")
dev.off()

listInput <- list(mascot = paste(results_mascot_annot_disc_2UniqPep$PSM) , comet = paste(results_comet_annot_disc_2UniqPep$PSM), omssa =paste(results_omssa_annot_disc_2UniqPep$PSM), tandem=paste(results_tandem_annot_disc_2UniqPep$PSM)  )

pdf(file = paste0(plotDir, "results_upsetR_PSM_PerSearchEngine.pdf"), width = 10, height = 10)
upset(fromList(listInput), order.by = "freq")
dev.off()
