...
nextprotXensgXgeneCode <- merge(nextprot_enspxensg, genecodev28_Annot, by.x=9, by.y=12, all.x=F, all.y=F)
...
unknown_function<-read.table("/home/tereshkova/data/jgonzalez/margaret/21_neXtprot_2020_01_17/nextprot-unknown_function.txt")
